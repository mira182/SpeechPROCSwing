...
appendFileLine: outputStatsFileName$, "Jitter (%) Shimmer (%) F0 mean (Hz) F0 median (Hz) F0 stdev (Hz) F0 min (Hz) F0 max (Hz)"
appendFileLine: outputStatsFileName$, percent$ (jitter, 3), " ", percent$ (shimmer, 3), " ", fixed$ (mean, 3), " ", fixed$ (median, 3), " ", fixed$ (stdev, 3), " ", fixed$ (f0min, 3), " ", fixed$ (f0max, 3)